...
Меня зовут Стасян, и я начинающий разработчик плагинов для Minecraft. Сейчас активно изучаю тонкости создания плагинов под ядра **Spigot** и **Paper**, работаю с **Bukkit API** и осваиваю **NMS** для реализации кастомных механик.
...
|------|----------|------|--------|
| `SixLeave` | Плагин на ливалки | Spigot/Paper (1.16.5) | ✅ Готово |
